  ...
  return (
    <div className={styles.mainWrapper}>
      ...
      <div className={`${styles.congratsText} ${animationStep >= 2 ? styles.congratsVisible : ''}`}>
        ...
        <p className={styles.congratsSubtitlenew}>Your investment of <br/><span>₹3,98,052 is approved.</span><br/>
            The amount will reflect in your account on <br/>25/11/2025</p>
