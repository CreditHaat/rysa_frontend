...
function LastAnimatinpage() {
  ...
  return (
    <div className={styles.mainWrapper}>
      ...
      >
        <h2 className={styles.sadTitle}>Oop&#39;s sorry!</h2>
        <p className={styles.sadSubtitle}>
          Your loan application <br/>could not be approved..
        </p>
        <p className={styles.lasstMessage}>But don&#39;t worry - you can still explore offers<br/> from other trusted partners.</p>
