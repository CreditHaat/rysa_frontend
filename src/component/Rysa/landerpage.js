      ...
      <div className={styles.container}>
        ...
        <div className={styles.section}>
          <div className={styles.lederDiv}>
            <h3>
              Lending Partner Of <span>AryseFin</span>
            </h3>
            {/* first */}
            <div className={styles.imageTextButton}>
              <div>
                <Image src={Pahal} width={80} height={50} alt="logo" />
                <h3>Pahal</h3>
              </div>
            ...
            <div className={styles.imageTextButton}>
              <div>
                <Image src={Kissht} width={80} height={50} alt="logo" />
                <h3>Kissht</h3>
              </div>
              <div className={styles.tANDb}>
                <div className={styles.textContainer}>
                ...
                <div className={styles.onlybtn}>
                  ...
                  <div className={styles.btnContainer}>
                    <button className={styles.btn}>
                      <a
                        href="https://www.kissht.com/customer-grievance"
                        target="_blank"
                      >
                        <span>Know More </span>
                      </a>
            ...
            <div className={styles.imageTextButton}>
              <div>
                <Image src={BFL} width={80} height={50} alt="logo" />
            ...
            <div className={styles.imageTextButton}>
              <div>
                <Image src={ABCL} width={80} height={50} alt="logo" />
