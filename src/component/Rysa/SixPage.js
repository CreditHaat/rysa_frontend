      ...
      <section className={styles.card}>
        <header className={styles.hero}>
          ...
          <div className={styles.imgWrap}>
            <Image src={slides[currentSlide].img} alt="Hero visual" fill priority style={{ objectFit: 'contain', objectPosition: 'center' }} /> {/*objectFit: 'cover' // objectFit: 'contain', objectPosition: 'center'*/}
          </div>
        </header>
