        ...
        <main className={styles.main}>
          <div className={styles.content}>
            ...
            <p className={styles.intro}>
              We aim to delight our customers and work hard to make sure that we
              help our customers avail the best credit solutions from our vast
              network of lending partners. However we understand that even with
              our best efforts we may get it wrong some times. If you have a
              complaint or would like us to address any concerns please reach
              out to us at{" "}
            ...
            <div className={styles.escalation}>
              ...
              <p className={styles.escalationText}>
                If your query&#47;complaint has not been addressed within 7
                working days; please reach out to our Grievance Redressal
            ...
            <div className={styles.grievanceOfficer}>
              <h3 className={styles.officerTitle}>
                ...
                <span className={styles.officerName}>Monika Kaushik</span>
              </h3>
              ...
              <div className={styles.contactDetails}>
                ...
                <div className={styles.contactItem}>
                  ...
                  <span className={styles.value}>
                    <a
                      href="mailto:support@arysefin.com"
